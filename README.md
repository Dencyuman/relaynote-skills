...
`main` contains the current stable skill. Releases use semantic Git tags (`v1.2.1`)
...
`https://github.com/dencyuinc/relaynote-skills/tree/v1.2.1` instead of the shorthand.
