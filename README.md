...
A Relaynote account and an OAuth-capable MCP client are required. API keys are not used.

## Releases

`main` contains the current stable skill. Releases use semantic Git tags (`v1.0.0`)
...
`https://github.com/dencyuinc/relaynote-skills/tree/v1.0.0` instead of the shorthand.
